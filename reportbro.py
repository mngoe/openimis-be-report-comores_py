    ...
    def __init__(self, report_definition, data, is_test_data=False, additional_fonts=None,
        ...
        self.additional_fonts = [
            dict(
                ...
                bold_filename='/openimis-be/openIMIS/fonts/DejaVuSans-Bold.ttf',
                italic_filename='/openimis-be/openIMIS/fonts/DejaVuSans-Oblique.ttf',
                bold_italic_filename='/openimis-be/openIMIS/fonts/DejaVuSans-BoldOblique.ttf'
            ),
        ]
        self.page_limit = page_limit
